    ...
    <div id="content">
      <div id="home-jumbotron" className="jumbotron">
        ...
        <div className="description">
          ...
          <p>
            If you’re excited by advanced cryptography, distributed systems, protocol design or public goods, please reach
            out by twitter DM: we are excited to hear from you, regardless of education, experiences or culture.
          </p>
        </div>
      </div>
    </div>
